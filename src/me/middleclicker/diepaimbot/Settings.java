...
Color List (RGB):
    ...
    Tank Upgrade Checker: 146,248,244
...
public class Settings {
    ...
    // Settings
    public static String mode = "Teams"; // FFA or Teams
    public static String team;
    public static boolean farmingMode = false;
    ...
    public static boolean doBuild = true;
    public static boolean doTankUpgrade = true;
    public static String targetTank = "Sniper";
}
